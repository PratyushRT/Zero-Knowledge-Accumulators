...
{	
    ...
    cout << "Please enter an email address you want to check: \n"; 
    getline(cin, line); 
    char *cstr = &line[0];


    if(CheckWord("zkacc/set/1000emails.txt",  cstr)==false){
	ZZ_p test_mem;
	test_mem = hashToGroup(line);
	std::ofstream out("zkacc/test/test_nonmem.txt");
    ...
    std::ofstream out1("zkacc/test/test_nonmem_email.txt");
    ...
    std::cout.rdbuf(coutbuf);
        ...
        cout<< "Given email is member, please generate membership proof instead"<<endl;
    }
